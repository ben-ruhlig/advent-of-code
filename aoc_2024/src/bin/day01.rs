...
fn main() {
    ...
    println!("Day01 P1: {}", get_answer_p1(&filepath));
...
mod tests {
    ...
    #[test]
    fn day01_p1() {
        let filepath = path::Path::new(env!("CARGO_MANIFEST_DIR")).join("input/day01_test.txt");
        assert_eq!(11, get_answer_p1(&filepath));
    }
    #[test]
    fn day01_p2() {
        let filepath = path::Path::new(env!("CARGO_MANIFEST_DIR")).join("input/day01_test.txt");
        assert_eq!(31, get_answer_p2(&filepath));
    }
}
